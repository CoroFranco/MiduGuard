...
export default function SignUpPage() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(backLinkRef.current, { x: -20, opacity: 0 }, { x: 0, opacity: 0.6, duration: 0.5 }, "-=1.0")
    ...
    tl.fromTo(infoBoxRef.current, { y: 15, opacity: 0 }, { y: 0, opacity: 1, duration: 0.5 }, "-=0.4")

    tl.fromTo(watermarkRef.current, { opacity: 0 }, { opacity: 0.4, duration: 0.5 }, "-=0.2")
